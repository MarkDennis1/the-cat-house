                ...
                <div class="h-[90vh] flex mx-20 items-center justify-center text-center">
                    <div class="bg-slate-100 rounded-lg border p-5 flex flex-col items-center justify-center gap-5">
                        ...
                        <p class="text-base font-semibold uppercase tracking-wider">
                            The protocols that we used for adoption are based on Philippine Animal Welfare (PAW) These
                            has
                            already been through difficult times. we need to make sure that they will find a home that
                            will
                            truely love them
                        </p>

                        <div>
                            <p class="font-semibold uppercase">Fill out the application form</p>
                            <p>Please download and fill out the adoption form. Kindly attach the photos of your home for
                                ocular
                                inspection particularly the area where your new pet will be kept.</p>
                        </div>

                        <div>
                            <p class="font-semibold uppercase">Zoom interview</p>
                            <p>Because of the pandemic, we use zoom for the interview. Using the form, you will be asked
                                to
                                select a date and time for your 1st interview at least 3 days in advance. That way, we
                                can
                                check
                                our availability of our interview date.</p>
                        </div>

                        <div class="mb-5">
                            <p class="font-semibold uppercase">Shelter visits</p>
                            <p>Your visit will be scheduled if you pass the interview. The 1st visit is where you will
                                choose
                                your prospective pet and have your 2nd interview. The 2nd visit is the time to bond with
                                your
                                pet and finalize your application then you may take your pet.</p>
                        </div>
