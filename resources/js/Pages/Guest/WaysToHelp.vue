    ...
    <div class="bg-gray-100 min-h-screen">
        ...
        <main class="bg-gray-100 px-8 pt-24 pb-8 text-sm">
            <div class="bg-[#D0EEE8] rounded-lg shadow-xl">
                <div class="h-[90vh] flex items-center justify-center text-center">
                    <div class="bg-slate-100 py-10 rounded-lg border md:px-20 lg:px-40">
                ...
                <div class="mt-20 pb-10 text-center">
                    ...
                    <div class="mt-10 flex flex-col gap-3 md:px-20 md:gap-5 lg:px-40 lg:flex-row">
                        <div class="bg-slate-100 px-3 py-3 rounded-lg border dark:bg-slate-800">
                            ...
                            <p class="mb-1">
                                The cat House is funded by donations and adoption fees. All the
                                financial helps are for the cats.
                            </p>
                            <p>
                                You can donate throudhgh gcash or message us on our Facebook page.
                            </p>
                        </div>

                        <div
                            class="bg-slate-100 px-3 py-2 rounded-lg border dark:bg-slate-800 md:flex md:flex-col md:justify-between">
                            <div>
                                <p class="mb-3 font-semibold uppercase">Volunteer</p>
                                <p class="mb-1">
                                    The cat House is staffed and manage by volunteers. Those people
                                    who love and care with pets.
                                </p>
                                <p>We are open for more volunteers.</p>
                            </div>
                        </div>
                        ...
                        <div
                            class="bg-slate-100 px-3 py-2 rounded-lg border dark:bg-slate-800 md:flex md:flex-col md:justify-between">
                            <div>
                                <p class="mb-3 font-semibold uppercase">Wish List</p>
                                <p>
                                    The shelter takes a lot of supplies and equipment to care for 202
                                    cats. See a list of them on our wish list.
                                </p>
                            </div>
                        </div>
                    </div>
