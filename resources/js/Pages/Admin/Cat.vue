        ...
        <Modal :show="showModal" maxWidth="lg">
            <form @submit.prevent="onSubmit" class="p-4">
                ...
                <div class="h-[72vh] overflow-auto">
                    <div class="m-6">
                        <label for="image_path" class="block mb-2 text-sm font-medium text-gray-900">Image</label>
                        <div class="flex justify-center items-center mb-2">
                            <img v-if="form.title == 'Edit Cat'" id="modalImg" class="rounded-full w-60 h60"
                                :src="form.image_path" />
                        </div>

                        <input v-if="form.title == 'Add New Cat'" @input="form.image_path = $event.target.files[0]"
                            class="block w-full mb-5 text-xs text-gray-900 border border-gray-300 rounded-lg cursor-pointer bg-gray-50 dark:text-gray-400 focus:outline-none dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400"
                            id="image_path" accept="image/png, image/jpeg" type="file" />
                    ...
                    <div class="m-6">
                        <label for="age_category" class="block mb-2 text-sm font-medium text-gray-900">Age
                            Category</label>
                        <select id="age_category" v-model="form.age_category"
                            class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5">
                    ...
                    <div class="m-6">
                        <label for="tags" class="block mb-2 text-sm font-medium text-gray-900">Tags (Separated by comma
                            ",")</label>
                    ...
                    <div class="px-4 py-2 bg-white rounded-t-lg dark:bg-gray-800">
                        <label for="color" class="block mb-2 text-sm font-medium text-gray-900">Description
                            (optional)</label>
            ...
            <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                <div class="bg-[#D0EEE8] overflow-hidden shadow-xl sm:rounded-lg">
                    <div class="overflow-x-auto relative shadow-md sm:rounded-lg">
                        <div class="p-4 bg-[#D0EEE8] flex justify-end items-center">
                        ...
                        <table class="w-full text-sm text-left text-gray-500 -gray-400">
                            ...
                            <tbody>
                                <tr v-for="cat in cats" :key="cat.id"
                                    ...
                                    <td class="p-4 w-4">
                                        <img class="rounded-full" :src="cat.image_path" :alt="cat.name" />
                                        <!-- {{ cat.image_path }} -->
                                    </td>
                                    ...
                                    <td class="py-4 flex items-center justify gap-1">
                                        ...
                                        <button @click="onDestroy(cat.id)" type="button"
