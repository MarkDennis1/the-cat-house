    ...
    <AppLayout title="schedule">
                ...
                <div class="overflow-auto h-[72vh]">
                    ...
                    <div class="m-6">
                        <label for="phone_number" class="block mb-2 text-sm font-medium text-gray-900">Phone
                            Number</label>
                        <input disabled type="text" id="phone_number"
                            class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5"
                    ...
                    <div class="m-6">
                        <label for="animal_id" class="block mb-2 text-sm font-medium text-gray-900">Animal ID</label>
                        <input disabled type="text" id="animal_id"
                            class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5"
                            v-model="form.animal_id" />
                        <InputError :message="form.errors.animal_name" />
                    </div>
                    <div class="m-6">
                        <label for="animal_name" class="block mb-2 text-sm font-medium text-gray-900">Animal
                            Name</label>
                        <input disabled type="text" id="animal_name"
                            class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5"
                    ...
                    <div class="m-6">
                        <label for="tags" class="block mb-2 text-sm font-medium text-gray-900">Address</label>
                    ...
                    <div class="m-6">
                        <div class="relative">
                            ...
                            <input disabled datepicker datepicker-orientation="bottom right" type="date"
                                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full pl-10 p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                placeholder="Select date" v-model="form.appointment" />
                        </div>
        ...
        schedule.last_name
                                    ...
                                    <td class="flex gap-1 py-4 px-6">
                                        <button @click="openModal(true, schedule)" type="button"
                                        ...
                                        <button @click="onDestroy(schedule.id)" type="button"
                        ...
                        <div class="text-center text-xl w-full p-4" v-if="schedules.length == 0">
